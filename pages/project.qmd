...
- Submit your **project topic** using the [topic submission form](https://forms.office.com/r/QhwKkKjtyz) by **Friday, March 6, 2026**.
- After the topic deadline, check the posted [topic list](https://iit0-my.sharepoint.com/:x:/g/personal/hickernell_illinoistech_edu/IQD_ndHS_ccARI2t5P_RlntGAb7BsS4mbeDauulSUaEPpzc?e=EizKdN) to confirm approval and double check the schedule.  This list updates regularly but not immediately.
