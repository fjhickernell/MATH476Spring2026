...
- Data from different populations: $X_1,\dots,X_{n_1}, \quad Y_1,\dots,Y_{n_2}$

- Are the populations similar or different?
...
- Data:
  $$
  m \text{ groups}, \quad X_{ij}, \; i=1,\dots,n_j
  $$
...
- If all groups are similar:
  - rank sums should be similar

- Large differences in rank sums:
